...
export const ReplyIcon = (props: IconProps) => (
  <Icon viewBox="0 0 24 24" {...featherIconsBaseProps} {...props}>
    <path
      style={{ opacity: 0.884 }}
      fill="#0080ba"
      d="M 23.5,15.5 C 23.5,16.5 23.5,17.5 23.5,18.5C 19.4943,14.1617 14.4943,12.1617 8.5,12.5C 8.5,13.5 8.5,14.5 8.5,15.5C 7.44802,15.6495 6.44802,15.4828 5.5,15C 3.62976,12.9604 1.62976,11.1271 -0.5,9.5C -0.5,8.5 -0.5,7.5 -0.5,6.5C 1.62976,4.87294 3.62976,3.03961 5.5,1C 6.44802,0.517215 7.44802,0.350549 8.5,0.5C 8.5,1.5 8.5,2.5 8.5,3.5C 15.8854,4.55512 20.8854,8.55512 23.5,15.5 Z"
    />
  </Icon>
)

export const ShareButtonIcon = (props: IconProps) => (
  <Icon viewBox="0 0 36 36" {...featherIconsBaseProps} {...props}>
    <path
      style={{ opacity: 0.953 }}
      fill="#03a7f4"
      d="M 5.5,3.5 C 8.16667,3.5 10.8333,3.5 13.5,3.5C 13.5,4.83333 13.5,6.16667 13.5,7.5C 11.2776,7.17798 9.44425,7.84464 8,9.5C 7.33333,14.8333 7.33333,20.1667 8,25.5C 8.5,26 9,26.5 9.5,27C 14.8333,27.6667 20.1667,27.6667 25.5,27C 27.1554,25.5557 27.822,23.7224 27.5,21.5C 28.8333,21.5 30.1667,21.5 31.5,21.5C 32.0065,25.0071 31.3398,28.1737 29.5,31C 21.5,31.6667 13.5,31.6667 5.5,31C 5,30.5 4.5,30 4,29.5C 3.33333,21.5 3.33333,13.5 4,5.5C 4.71719,4.9558 5.21719,4.28913 5.5,3.5 Z"
    />
    <path
      style={{ opacity: 0.891 }}
      fill="#00a5f4"
      d="M 17.5,3.5 C 21.8461,3.33432 26.1794,3.50098 30.5,4C 31.4667,8.40142 31.8,12.9014 31.5,17.5C 30.1667,17.5 28.8333,17.5 27.5,17.5C 27.6621,15.4727 27.4955,13.4727 27,11.5C 24.5,14 22,16.5 19.5,19C 18.2068,19.49 16.8734,19.6567 15.5,19.5C 15.3433,18.1266 15.51,16.7932 16,15.5C 18.5,13 21,10.5 23.5,8C 21.5273,7.50454 19.5273,7.33788 17.5,7.5C 17.5,6.16667 17.5,4.83333 17.5,3.5 Z"
    />
  </Icon>
)
...
export const SendMessage = (props: IconProps) => (
  <Icon viewBox="0 0 24 24" {...featherIconsBaseProps} {...props}>
    <path fill="currentColor" d="M2,21L23,12L2,3V10L17,12L2,14V21Z" />
  </Icon>
)

export const ReceiveMessage = (props: IconProps) => (
  <Icon viewBox="0 0 24 24" {...featherIconsBaseProps} {...props}>
    <path fill="currentColor" d="M22,21L1,12L22,3V10L7,12L22,14V21Z" />
  </Icon>
)
